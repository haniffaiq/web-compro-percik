    ...
    return (
      <>
        ...
        <div className="p-9 lg:px-0 lg:py-4 lg:ml-32 lg:pl-[145px] lg:pr-28">
          ...
          <div className="text-md lg:text-[24px] text-start leading-normal lg:mt-[0px] mt-[-30px] mx-[40px] w-[250px] lg:w-full">
            {globalState.globalProperty === "IND"
          ...
          <div className="flex flex-col gap-5 text-md lg:text-[24px] mt-[-30px] lg:mt-0 text-black leading-normal px-4">
            <ul className="list-disc mx-[40px] w-[220px] lg:w-full">
              <li>
                {" "}
                {globalState.globalProperty === "IND"
          ...
          <div className="ml-[-22px] text-black leading-normal w-[350px] mt-[-40px]">{globalState.globalProperty === "IND" ? <img src={ValueIdMobile} alt="value-pict-indo" /> : <img src={ValueEnMobile} alt="value-pict-en" />}</div>;
        </div>
      </>
    );
  }
    ...
    return (
      <>
        ...
        <div className="p-9 lg:px-0 lg:py-4 lg:ml-32 lg:pl-[145px] lg:pr-28">
          ...
          <div className="lg:text-start text-center text-3xl lg:text-[42px] py-12 mt-[10px] " style={{ fontFamily: "Hedvig Letters Serif, serif" }}>
            {globalState.globalProperty === "IND" ? "Misi" : "Mission"}
          </div>
          <div className="flex flex-col gap-5 text-md lg:text-[24px] mt-[-30px] lg:mt-0 text-black leading-normal px-4">
            <ul className="list-disc mx-[40px] w-[220px] lg:w-full">
          ...
          <div className="grid grid-row gap-0 my-5 text-black leading-normal px-4">{globalState.globalProperty === "IND" ? <img src={ValueInd} alt="value-pict-indo" /> : <img src={ValueEn} alt="value-pict-en" />}</div>;
        </div>
      </>
    );
  }
