          ...
          {Object.keys(selectedData).map((key) => (
            <div key={selectedData[key].id} className="flex flex-col-reverse lg:grid lg:grid-cols-3 mt-0 lg:mt-10 lg:gap-0 gap-5 p-5 rounded-lg">
              <div className="col-span-2">
                ...
                <div className="flex flex-col gap-5 text-[7px] lg:text-lg mt-5 lg:mt-10 text-black w-full lg:w-[800px] text-justify">{history[key].content}</div>
              </div>
              <div className="flex flex-col items-center gap-5">
                <img loading="lazy" src={Pandu} className="lg:object-cover flex h-[300px] lg:h-full" alt="Ibu Pandu Soeradhiningrat" />
                <div className="text-end font-semibold">Ibu Pandu Soeradhiningrat</div>
              </div>
            </div>
          ))}
