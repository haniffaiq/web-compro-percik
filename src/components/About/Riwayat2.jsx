            ...
            {Object.keys(selectedData).map((key) => (
              <div className="lg:flex gap-5 mt-10">
                <img
                  ...
                  className="lg:object-cover flex h-[200px] lg:h-[300px] gap-10 lg:w-[250px] w-full"
                  alt="selectedData[key].imgUrl"
                />
                {/* <div className="text-end font-semibold">Ibu Pandu Soeradhiningrat</div> */}
                <div className="col-span-2 lg:ml-[2px]">
                  <div className="text-[12px] lg:text-[24px] font-bold text-black">
                    {selectedData[key].title}
                  </div>
                  <div className="flex flex-col gap-5 text-[12px] lg:text-[14px] mt-5 lg:mt-10 text-black w-full lg:w-auto text-left">
                    {selectedData[key].content.slice(0, 300)}...
                  </div>
                </div>
              </div>
            ))}
