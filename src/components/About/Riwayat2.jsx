      ...
      <div className="px-5 lg:px-8">
        <div className="w-full rounded-xl">
          {Object.keys(selectedData).map((key) => (
            <div key={selectedData[key].id} className="flex flex-col lg:grid lg:grid-cols-3 mt-0 lg:mt-10 lg:gap-0 gap-5 p-5 rounded-lg">
              <div className="flex flex-col items-center gap-5">
                <img loading="lazy" src={selectedData[key].imgUrl} className="lg:object-cover flex h-[300px] lg:h-full" alt="selectedData[key].imgUrl" />
                {/* <div className="text-end font-semibold">Ibu Pandu Soeradhiningrat</div> */}
              </div>
              <div className="col-span-2 lg:ml-24">
                <div className="text-[12px] lg:text-4xl font-bold text-black">{selectedData[key].title}</div>
                <div className="flex flex-col gap-5 text-[12px] lg:text-lg mt-5 lg:mt-10 text-black w-full lg:w-auto text-left">{selectedData[key].content}</div>
              </div>
