        ...
        <div className="parent-container">
          ...
          <div className="main-container-layout-pengawas">
            ...
            <div className="bullet-points-pengawas">
              <ul>
                <li className="leading-normal">
                  {globalState.globalProperty === "IND" ? "Universal dan obyektif dalam ilmu pengetahuan untuk mencapai kenyataan dan kebenaran." : "Universal and objective in scientific knowledge to achieve reality and truth."}
                </li>
                <li className="leading-normal">{globalState.globalProperty === "IND" ? "Kebebasan akademik yang dilaksanakan dengan hikmah dan bertanggungjawab." : "Academic freedom exercised with wisdom and responsibility."}</li>
                <li className="leading-normal">{globalState.globalProperty === "IND" ? "Keadaban, kemanfaatan, kebahagiaan, kemanusiaan dan kesejahteraan." : "Civility, usefulness, happiness, humanity, and well-being."}</li>
                <li className="leading-normal">{globalState.globalProperty === "IND" ? "Aktualisasi nilai-nilai kebangsaan dan Pancasila dalam kehidupan akademik." : "Actualization of national values and Pancasila in academic life."}</li>
                <li className="leading-normal">{globalState.globalProperty === "IND" ? "Pendidikan yang unggul." : "Excellence in education."}</li>
                <li className="leading-normal">
                  {globalState.globalProperty === "IND"
                ...
                <li className="leading-normal">
                  {globalState.globalProperty === "IND" ? "Pengayaan budaya untuk mendukung kemandirian serta keutuhan bangsa dan negara." : "Cultural enrichment to support national independence and integrity."}
                </li>
                <li className="leading-normal">
                  {globalState.globalProperty === "IND"
                ...
                <li className="leading-normal">
                  {globalState.globalProperty === "IND" ? "Pengembangan jaringan kerjasama menuju pembangunan masyarakat yang demokratis." : "Development of cooperation networks towards the development of a democratic society."}
                </li>
              </ul>
            </div>
          </div>
